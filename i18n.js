...
(function () {
  var D = {
    ...
    uk: {
      ...
      close_match_suffix: 'збіг',
      verdict_exceptional: 'Виняткова сумісність', verdict_strong: 'Сильний збіг',
      verdict_good: 'Гарний збіг', verdict_base: 'Є основа',
      trait_openness: 'Відкритість', trait_conscientiousness: 'Сумлінність',
      trait_extraversion: 'Товариськість', trait_agreeableness: 'Доброзичливість',
      trait_stability: 'Емоц. стабільність',
      // settings
      settings_title: 'Налаштування', aria_settings: 'Налаштування',
      set_sec_account: 'Акаунт', set_edit_profile: 'Редагувати профіль',
      set_verification: 'Верифікація', set_verif_val: 'Telegram',
      set_sec_feed: 'Показ у стрічці', set_show_me: 'Показувати мене',
      set_show_me_sub: 'Твій профіль бачитимуть інші',
      set_age_range: 'Вікові межі', set_age_range_val: '±10 років',
      set_distance: 'Максимальна відстань', set_distance_val: 'Без обмежень',
      set_sec_privacy: 'Приватність', set_incognito: 'Режим інкогніто',
      set_incognito_sub: 'Тебе бачать лише ті, кого ти вподобав',
      set_read_receipts: 'Позначки прочитання', set_blocked: 'Заблоковані',
      set_sec_notif: 'Сповіщення', set_notif_match: 'Нові метчі', set_notif_msg: 'Повідомлення',
      set_sec_appearance: 'Вигляд', set_dark_theme: 'Темна тема',
      set_logout: 'Вийти з акаунта', set_version: 'Sixtio · версія {v}',
      close: 'Закрити',
      // index (welcome)
      ...
      mn_menu: 'Дії', mn_block: 'Заблокувати', mn_unblock: 'Розблокувати',
      mn_report: 'Поскаржитися', mn_cancel: 'Скасувати',
      mn_report_r1: 'Образи чи агресія', mn_report_r2: 'Фейк або спам', mn_report_r3: 'Інше',
      mn_block_q: 'Заблокувати цю людину? Ви більше не побачите одне одного.',
      mn_report_q: 'Поскаржитися на цю людину? Опишіть причину (необовʼязково):',
      mn_report_ph: 'Причина скарги…',
      mn_blocked: 'Заблоковано.', mn_unblocked: 'Розблоковано.',
      mn_reported: 'Дякуємо. Скаргу надіслано на розгляд.',
      ...
      mt_my_desires: 'Твої бажання (їх бачить партнер)',
      ...
      pn_welcome_title: '🎁 Тобі Premium на 10 днів',
      pn_welcome_msg: 'Вітаємо в Sixtio! Даруємо Premium: фото без розмиття, безлімітні лайки й усі, кому ти сподобався. Діє до {date}.',
      pn_welcome_btn: 'Чудово',
      pn_d3_title: '⏳ Premium закінчується',
      pn_d3_msg: 'Твій Premium діє ще {days}. Поповни зірки й продовж, щоб не втратити фото без розмиття та безлімітні лайки.',
      pn_d1_title: '⏰ Останній день Premium',
      pn_d1_msg: 'Premium закінчується {date}. Продовж за {price} ⭐ — і все лишиться як є.',
      pn_extend_btn: 'Продовжити',
      pn_later_btn: 'Пізніше',
      pn_shop_sub: 'Продовж Premium ще на 30 днів',
      pn_days_one: '{n} день', pn_days_few: '{n} дні', pn_days_many: '{n} днів',
      wb_title: '🎁 Вітальний бонус',
      wb_sub: 'Повний доступ безкоштовно до {date}: фото без розмиття, необмежені лайки і всі, кому ти сподобався. Нічого платити не треба.',
      depth_title: 'Глибина профілю',
      depth_full: 'Профіль заповнено повністю', depth_partial: 'Заповнено {pct}%', psychotype: 'Психотип', invite_title: 'Запроси друзів', dark_mode_title: 'Dark Mode',
      ...
      // AI-звіт: читання (знак + соціотип) безкоштовне назавжди, платний лише текст.
      report_title: 'AI-звіт про тебе',
      report_sub_setup: 'Додай дату народження — і побачиш свій розбір',
      report_sub_free: '{sign} · {type} — звіт за {p} ⭐',
      report_sub_ready: 'Твій звіт готовий — читати',
      report_birth_q: 'Коли ти народився?',
      report_birth_q_f: 'Коли ти народилася?',
      report_birth_hint: 'Дата потрібна для сонячного знаку. Час і місто — необовʼязкові: без них це знак, а не повна натальна карта.',
      report_time_ph: 'Час (напр. 14:30)',
      report_place_ph: 'Місто народження',
      report_save: 'Зберегти',
      report_free_title: 'Твоє читання — безкоштовно',
      report_sign_l: 'Знак',
      report_type_l: 'Соціотип',
      report_axes_l: 'Осі',
      // Phrased so it reads correctly for one weak axis or for four: naming the
      // axes and then commenting sidesteps the noun agreement entirely.
      report_weak_note: '{x} — тут ти майже посередині, тож у звіті це сказано обережно.',
      report_paid_title: 'Повний звіт',
      report_paid_lead: 'Довгий персональний розбір: хто ти, як любиш, у чому твоя сила й пастка, хто тобі підходить і що робити далі.',
      report_buy: 'Отримати звіт · {p} ⭐',
      report_retry: 'Спробувати ще раз',
      report_writing: 'Пишу твій звіт… це займе до хвилини',
      report_err_low: 'Не вистачає зірок',
      report_err_traits: 'Спершу заверши профіль — звіт будується на твоїх відповідях',
      report_err_date: 'Спершу додай дату народження',
      report_err_fail: 'Не вийшло згенерувати. Зірки на місці — просто спробуй ще раз.',
      report_paid_note: 'Оплачено. Звіт зберігається назавжди, перечитувати можна безкоштовно.',
      report_disclaimer: 'Основа звіту — твій психологічний профіль Sixtio, побудований на твоїх відповідях. Знак зодіаку й соціотип — це мова опису та розвага, а не діагноз і не медична порада.',
      report_sec_core: 'Хто ти насправді',
      report_sec_love: 'Як ти любиш',
      report_sec_strength: 'Сила і пастка',
      report_sec_fit: 'Хто тобі підходить',
      report_sec_next: 'Що робити далі',
      soc_axis_E: 'екстраверсія', soc_axis_I: 'інтроверсія',
      soc_axis_N: 'інтуїція', soc_axis_S: 'сенсорика',
      soc_axis_F: 'етика', soc_axis_T: 'логіка',
      soc_axis_J: 'раціональність', soc_axis_P: 'ірраціональність',
      ...
      sign_sagittarius: 'Стрілець', sign_capricorn: 'Козоріг', sign_aquarius: 'Водолій', sign_pisces: 'Риби',
      elem_fire: 'вогонь', elem_earth: 'земля', elem_air: 'повітря', elem_water: 'вода',
      soc_ILE: 'Шукач', soc_SEI: 'Посередник', soc_ESE: 'Ентузіаст', soc_LII: 'Аналітик',
      soc_EIE: 'Наставник', soc_LSI: 'Інспектор', soc_SLE: 'Маршал', soc_IEI: 'Лірик',
      soc_LIE: 'Підприємець', soc_ESI: 'Охоронець', soc_SEE: 'Політик', soc_ILI: 'Критик',
      soc_IEE: 'Порадник', soc_SLI: 'Майстер', soc_LSE: 'Адміністратор', soc_EII: 'Гуманіст',
      interests: 'Інтереси',
      values: 'Цінності',
      bio_nudge: '💬 Додай пару слів про себе (✎)',
      referral_sub: '+15 ⭐️ за друга, який залишиться',
      ...
      ach_complete_100: 'Профіль на 100%',
      achieve_next: 'Ти близько до «{label}» — {pct}%',
      ...
      dark_off: 'Dark Mode тимчасово недоступний',
      dark_stale: 'Умови Dark Mode оновились. Переглянь їх, щоб продовжити.',
      dc_title: 'Dark Mode',
      dc_lead: 'Ми використовуємо твої відповіді про вподобання, щоб рахувати інтимну сумісність.',
      dc_b1: 'Видно лише тим, у кого теж увімкнено Dark Mode',
      dc_b2: 'У стрічці — тільки спільні з тобою маркери',
      dc_b3: 'Після взаємного метчу ви бачите повні списки одне одного, однаково',
      dc_b4: 'Це неможливо купити за ⭐ і не показується нікому іншому',
      dc_affirm: 'Натискаючи «Увімкнути», ти підтверджуєш, що тобі виповнилось 18 років, і даєш згоду на обробку цих даних.',
      dc_enable: 'Увімкнути', dc_cancel: 'Скасувати',
      dc_policy: 'Вимкнути можна будь-коли — дані одразу перестають використовуватись.',
      dc_more: 'Політика конфіденційності',
      referral_terms: 'Нагорода нараховується, коли друг заповнить профіль щонайменше на 60% і повернеться в Sixtio на третій день. Кількість друзів не обмежена.',
      ...
      kink_q_4: 'Що більше заводить — повільна чуттєвість чи жагуча інтенсивність?',
      kink_q_5: 'Що цікаво спробувати: чуттєві дотики, іграшки, масаж, звабливі слова?',
      // profile — edit form
      ...
      ob_interests_q: 'Познач, що тобі близьке — обери зі списку. Своє зможеш додати згодом у профілі.',
      ob_interests_done: 'Готово',
      ...
      ob_photo_rejected: 'Це фото не відповідає правилам спільноти. Обери, будь ласка, інше — без відвертого чи образливого вмісту.',
      ob_photo_unavailable: 'Не вдалося перевірити фото — сервіс перевірки тимчасово недоступний. Спробуй, будь ласка, ще раз.',
      ob_photo_retry: '🔄 Спробувати ще раз',
      ...
      kink_tender: 'Ніжність', kink_playful: 'Грайливість', kink_slow: 'Без поспіху', kink_intense: 'Інтенсивність',
      kink_curious: 'Допитливість', kink_experimental: 'Експерименти', kink_adventurous: 'Авантюрність', kink_vanilla: 'Класика',
      kink_kissing: 'Поцілунки', kink_cuddling: 'Обійми', kink_massage: 'Масаж', kink_sensation_play: 'Чуттєві дотики',
      kink_teasing: 'Піддражнювання', kink_dirty_talk: 'Брудні розмови', kink_sexting: 'Секстинг', kink_fantasies: 'Фантазії',
      kink_roleplay: 'Рольові ігри', kink_toys: 'Іграшки', kink_bondage: 'Бондаж', kink_blindfold: 'Всліпу',
      ...
      pw_report_name: 'AI-звіт про тебе',
      pw_report_note: 'Знак і соціотип — безкоштовно. Платний — повний письмовий розбір, назавжди.',
    ...
    en: {
      ...
      close_match_suffix: 'match',
      verdict_exceptional: 'Exceptional match', verdict_strong: 'Strong match',
      verdict_good: 'Good match', verdict_base: 'A foundation',
      trait_openness: 'Openness', trait_conscientiousness: 'Conscientiousness',
      trait_extraversion: 'Extraversion', trait_agreeableness: 'Agreeableness',
      trait_stability: 'Emot. stability',
      // settings
      settings_title: 'Settings', aria_settings: 'Settings',
      set_sec_account: 'Account', set_edit_profile: 'Edit profile',
      set_verification: 'Verification', set_verif_val: 'Telegram',
      set_sec_feed: 'Feed visibility', set_show_me: 'Show me',
      set_show_me_sub: 'Others will see your profile',
      set_age_range: 'Age range', set_age_range_val: '±10 years',
      set_distance: 'Max distance', set_distance_val: 'No limit',
      set_sec_privacy: 'Privacy', set_incognito: 'Incognito mode',
      set_incognito_sub: 'Only people you liked can see you',
      set_read_receipts: 'Read receipts', set_blocked: 'Blocked',
      set_sec_notif: 'Notifications', set_notif_match: 'New matches', set_notif_msg: 'Messages',
      set_sec_appearance: 'Appearance', set_dark_theme: 'Dark theme',
      set_logout: 'Log out', set_version: 'Sixtio · version {v}',
      close: 'Close',
      ...
      mn_menu: 'Actions', mn_block: 'Block', mn_unblock: 'Unblock',
      mn_report: 'Report', mn_cancel: 'Cancel',
      mn_report_r1: 'Abuse or harassment', mn_report_r2: 'Fake or spam', mn_report_r3: 'Something else',
      mn_block_q: 'Block this person? You will no longer see each other.',
      mn_report_q: 'Report this person? Describe the reason (optional):',
      mn_report_ph: 'Reason for the report…',
      mn_blocked: 'Blocked.', mn_unblocked: 'Unblocked.',
      mn_reported: 'Thank you. Your report has been submitted for review.',
      ...
      mt_my_desires: 'Your desires (they see these)',
      ...
      pn_welcome_title: '🎁 10 days of Premium, on us',
      pn_welcome_msg: 'Welcome to Sixtio! Enjoy Premium: unblurred photos, unlimited likes and everyone who liked you. Active until {date}.',
      pn_welcome_btn: 'Great',
      pn_d3_title: '⏳ Premium is ending',
      pn_d3_msg: 'Your Premium has {days} left. Top up Stars and extend it to keep unblurred photos and unlimited likes.',
      pn_d1_title: '⏰ Last day of Premium',
      pn_d1_msg: 'Premium ends on {date}. Extend it for {price} ⭐ and keep everything as it is.',
      pn_extend_btn: 'Extend',
      pn_later_btn: 'Later',
      pn_shop_sub: 'Extend Premium for another 30 days',
      pn_days_one: '{n} day', pn_days_few: '{n} days', pn_days_many: '{n} days',
      wb_title: '🎁 Welcome bonus',
      wb_sub: 'Full access, free until {date}: unblurred photos, unlimited likes, and everyone who liked you. Nothing to pay.',
      depth_title: 'Profile depth',
      depth_full: 'Profile fully complete', depth_partial: '{pct}% complete', psychotype: 'Psychotype', invite_title: 'Invite friends', dark_mode_title: 'Dark Mode',
      ...
      report_title: 'Your AI report',
      report_sub_setup: 'Add your birth date to see your reading',
      report_sub_free: '{sign} · {type} — full report {p} ⭐',
      report_sub_ready: 'Your report is ready — read it',
      report_birth_q: 'When were you born?',
      report_birth_q_f: 'When were you born?',
      report_birth_hint: 'The date gives your sun sign. Time and city are optional — without them this is a sign, not a full natal chart.',
      report_time_ph: 'Time (e.g. 14:30)',
      report_place_ph: 'City of birth',
      report_save: 'Save',
      report_free_title: 'Your reading — free',
      report_sign_l: 'Sign',
      report_type_l: 'Type',
      report_axes_l: 'Axes',
      report_weak_note: '{x} — you sit close to the middle here, so the report says it carefully.',
      report_paid_title: 'The full report',
      report_paid_lead: 'A long personal read: who you are, how you love, your strength and the trap inside it, who fits you, and what to do next.',
      report_buy: 'Get the report · {p} ⭐',
      report_retry: 'Try again',
      report_writing: 'Writing your report… up to a minute',
      report_err_low: 'Not enough Stars',
      report_err_traits: 'Finish your profile first — the report is built on your answers',
      report_err_date: 'Add your birth date first',
      report_err_fail: 'Generation failed. Your Stars are safe — just try again.',
      report_paid_note: 'Paid. The report is kept forever and re-reading is free.',
      report_disclaimer: 'The report is grounded in your Sixtio personality profile, built from your own answers. The zodiac sign and socionics type are a language for describing you and a bit of fun — not a diagnosis and not medical advice.',
      report_sec_core: 'Who you really are',
      report_sec_love: 'How you love',
      report_sec_strength: 'Strength and trap',
      report_sec_fit: 'Who fits you',
      report_sec_next: 'What to do next',
      soc_axis_E: 'extraversion', soc_axis_I: 'introversion',
      soc_axis_N: 'intuition', soc_axis_S: 'sensing',
      soc_axis_F: 'ethics', soc_axis_T: 'logic',
      soc_axis_J: 'rationality', soc_axis_P: 'irrationality',
      ...
      soc_ILE: 'Seeker', soc_SEI: 'Mediator', soc_ESE: 'Enthusiast', soc_LII: 'Analyst',
      soc_EIE: 'Mentor', soc_LSI: 'Inspector', soc_SLE: 'Marshal', soc_IEI: 'Lyricist',
      soc_LIE: 'Entrepreneur', soc_ESI: 'Guardian', soc_SEE: 'Politician', soc_ILI: 'Critic',
      soc_IEE: 'Advisor', soc_SLI: 'Craftsman', soc_LSE: 'Administrator', soc_EII: 'Humanist',
      interests: 'Interests',
      values: 'Values',
      bio_nudge: '💬 Add a few words about yourself (✎)',
      referral_sub: '+15 ⭐️ per friend who stays',
      invite_btn: 'Invite',
      ...
      ach_complete_100: 'Profile 100%',
      achieve_next: 'You\'re close to “{label}” — {pct}%',
      ...
      dark_off: 'Dark Mode is temporarily unavailable',
      dark_stale: 'The Dark Mode terms have changed. Review them to continue.',
      dc_title: 'Dark Mode',
      dc_lead: 'We use your answers about preferences to compute intimate compatibility.',
      dc_b1: 'Visible only to people who also turned Dark Mode on',
      dc_b2: 'In the feed — only the markers you share',
      dc_b3: 'After a mutual match you see each other\'s full lists, equally',
      dc_b4: 'It cannot be bought with ⭐ and is shown to nobody else',
      dc_affirm: 'By pressing “Enable” you confirm that you are 18 or older and consent to the processing of this data.',
      dc_enable: 'Enable', dc_cancel: 'Cancel',
      dc_policy: 'You can turn it off anytime — the data stops being used immediately.',
      dc_more: 'Privacy Policy',
      referral_terms: 'The reward lands once your friend fills their profile to at least 60% and comes back to Sixtio on day three. No limit on how many friends you invite.',
      ...
      kink_q_4: 'What turns you on more — slow sensuality or fiery intensity?',
      kink_q_5: 'What would you like to try: sensual touch, toys, massage, teasing words?',
      ...
      ob_interests_q: 'Mark what resonates — pick from the list. You can add your own later in your profile.',
      ob_interests_done: 'Done',
      ...
      ob_photo_rejected: 'This photo doesn\'t meet our community guidelines. Please pick another one — no explicit or offensive content.',
      ob_photo_unavailable: 'We couldn\'t check this photo — the safety check is temporarily unavailable. Please try again.',
      ob_photo_retry: '🔄 Try again',
      ...
      kink_tender: 'Tender', kink_playful: 'Playful', kink_slow: 'Slow & sensual', kink_intense: 'Intense',
      kink_curious: 'Curious', kink_experimental: 'Experimental', kink_adventurous: 'Adventurous', kink_vanilla: 'Vanilla',
      kink_kissing: 'Kissing', kink_cuddling: 'Cuddling', kink_massage: 'Massage', kink_sensation_play: 'Sensation play',
      kink_teasing: 'Teasing', kink_dirty_talk: 'Dirty talk', kink_sexting: 'Sexting', kink_fantasies: 'Fantasies',
      kink_roleplay: 'Roleplay', kink_toys: 'Toys', kink_bondage: 'Bondage', kink_blindfold: 'Blindfold',
      ...
      pw_report_name: 'Your AI report',
      pw_report_note: 'Sign and socionics type are free. What you pay for is the full written read, kept forever.',
    ...
    ru: {
      ...
      close_match_suffix: 'совпад.',
      verdict_exceptional: 'Исключительная совместимость', verdict_strong: 'Сильное совпадение',
      verdict_good: 'Хорошее совпадение', verdict_base: 'Есть основа',
      trait_openness: 'Открытость', trait_conscientiousness: 'Добросовестность',
      trait_extraversion: 'Общительность', trait_agreeableness: 'Доброжелательность',
      trait_stability: 'Эмоц. стабильность',
      // settings
      settings_title: 'Настройки', aria_settings: 'Настройки',
      set_sec_account: 'Аккаунт', set_edit_profile: 'Редактировать профиль',
      set_verification: 'Верификация', set_verif_val: 'Telegram',
      set_sec_feed: 'Показ в ленте', set_show_me: 'Показывать меня',
      set_show_me_sub: 'Твой профиль будут видеть другие',
      set_age_range: 'Возрастные рамки', set_age_range_val: '±10 лет',
      set_distance: 'Максимальное расстояние', set_distance_val: 'Без ограничений',
      set_sec_privacy: 'Приватность', set_incognito: 'Режим инкогнито',
      set_incognito_sub: 'Тебя видят только те, кого ты отметил',
      set_read_receipts: 'Отметки о прочтении', set_blocked: 'Заблокированные',
      set_sec_notif: 'Уведомления', set_notif_match: 'Новые мэтчи', set_notif_msg: 'Сообщения',
      set_sec_appearance: 'Вид', set_dark_theme: 'Тёмная тема',
      set_logout: 'Выйти из аккаунта', set_version: 'Sixtio · версия {v}',
      close: 'Закрыть',
      ...
      mt_back: '‹ Назад', aria_back: 'Назад',
      mn_menu: 'Действия', mn_block: 'Заблокировать', mn_unblock: 'Разблокировать',
      mn_report: 'Пожаловаться', mn_cancel: 'Отмена',
      mn_report_r1: 'Оскорбления или агрессия', mn_report_r2: 'Фейк или спам', mn_report_r3: 'Другое',
      mn_block_q: 'Заблокировать этого человека? Вы больше не увидите друг друга.',
      mn_report_q: 'Пожаловаться на этого человека? Опишите причину (необязательно):',
      mn_report_ph: 'Причина жалобы…',
      mn_blocked: 'Заблокировано.', mn_unblocked: 'Разблокировано.',
      mn_reported: 'Спасибо. Жалоба отправлена на рассмотрение.',
      ...
      mt_my_desires: 'Твои желания (их видит партнёр)',
      ...
      pn_welcome_title: '🎁 Тебе Premium на 10 дней',
      pn_welcome_msg: 'Добро пожаловать в Sixtio! Дарим Premium: фото без размытия, безлимитные лайки и все, кому ты понравился. Действует до {date}.',
      pn_welcome_btn: 'Отлично',
      pn_d3_title: '⏳ Premium заканчивается',
      pn_d3_msg: 'Твой Premium действует ещё {days}. Пополни звёзды и продли, чтобы не потерять фото без размытия и безлимитные лайки.',
      pn_d1_title: '⏰ Последний день Premium',
      pn_d1_msg: 'Premium заканчивается {date}. Продли за {price} ⭐ — и всё останется как есть.',
      pn_extend_btn: 'Продлить',
      pn_later_btn: 'Позже',
      pn_shop_sub: 'Продли Premium ещё на 30 дней',
      pn_days_one: '{n} день', pn_days_few: '{n} дня', pn_days_many: '{n} дней',
      wb_title: '🎁 Приветственный бонус',
      wb_sub: 'Полный доступ бесплатно до {date}: фото без размытия, безлимитные лайки и все, кому ты понравился. Платить ничего не нужно.',
      depth_title: 'Глубина профиля',
      depth_full: 'Профиль заполнен полностью', depth_partial: 'Заполнено {pct}%', psychotype: 'Психотип', invite_title: 'Пригласи друзей', dark_mode_title: 'Dark Mode',
      ...
      report_title: 'AI-отчёт о тебе',
      report_sub_setup: 'Добавь дату рождения — и увидишь свой разбор',
      report_sub_free: '{sign} · {type} — отчёт за {p} ⭐',
      report_sub_ready: 'Твой отчёт готов — читать',
      report_birth_q: 'Когда ты родился?',
      report_birth_q_f: 'Когда ты родилась?',
      report_birth_hint: 'Дата нужна для солнечного знака. Время и город — необязательны: без них это знак, а не полная натальная карта.',
      report_time_ph: 'Время (напр. 14:30)',
      report_place_ph: 'Город рождения',
      report_save: 'Сохранить',
      report_free_title: 'Твоё чтение — бесплатно',
      report_sign_l: 'Знак',
      report_type_l: 'Социотип',
      report_axes_l: 'Оси',
      report_weak_note: '{x} — здесь ты почти посередине, поэтому в отчёте это сказано осторожно.',
      report_paid_title: 'Полный отчёт',
      report_paid_lead: 'Длинный персональный разбор: кто ты, как любишь, в чём твоя сила и ловушка, кто тебе подходит и что делать дальше.',
      report_buy: 'Получить отчёт · {p} ⭐',
      report_retry: 'Попробовать ещё раз',
      report_writing: 'Пишу твой отчёт… это займёт до минуты',
      report_err_low: 'Не хватает звёзд',
      report_err_traits: 'Сначала заверши профиль — отчёт строится на твоих ответах',
      report_err_date: 'Сначала добавь дату рождения',
      report_err_fail: 'Не получилось сгенерировать. Звёзды на месте — просто попробуй ещё раз.',
      report_paid_note: 'Оплачено. Отчёт хранится навсегда, перечитывать можно бесплатно.',
      report_disclaimer: 'Основа отчёта — твой психологический профиль Sixtio, построенный на твоих ответах. Знак зодиака и соционический тип — это язык описания и развлечение, а не диагноз и не медицинский совет.',
      report_sec_core: 'Кто ты на самом деле',
      report_sec_love: 'Как ты любишь',
      report_sec_strength: 'Сила и ловушка',
      report_sec_fit: 'Кто тебе подходит',
      report_sec_next: 'Что делать дальше',
      soc_axis_E: 'экстраверсия', soc_axis_I: 'интроверсия',
      soc_axis_N: 'интуиция', soc_axis_S: 'сенсорика',
      soc_axis_F: 'этика', soc_axis_T: 'логика',
      soc_axis_J: 'рациональность', soc_axis_P: 'иррациональность',
      ...
      elem_fire: 'огонь', elem_earth: 'земля', elem_air: 'воздух', elem_water: 'вода',
      soc_ILE: 'Искатель', soc_SEI: 'Посредник', soc_ESE: 'Энтузиаст', soc_LII: 'Аналитик',
      soc_EIE: 'Наставник', soc_LSI: 'Инспектор', soc_SLE: 'Маршал', soc_IEI: 'Лирик',
      soc_LIE: 'Предприниматель', soc_ESI: 'Хранитель', soc_SEE: 'Политик', soc_ILI: 'Критик',
      soc_IEE: 'Советчик', soc_SLI: 'Мастер', soc_LSE: 'Администратор', soc_EII: 'Гуманист',
      interests: 'Интересы',
      values: 'Ценности',
      bio_nudge: '💬 Добавь пару слов о себе (✎)',
      referral_sub: '+15 ⭐️ за друга, который останется',
      ...
      ach_zen_strategist: 'Дзен-Стратег',
      ach_complete_100: 'Профиль на 100%',
      achieve_next: 'Ты близко к «{label}» — {pct}%',
      ...
      dark_off: 'Dark Mode временно недоступен',
      dark_stale: 'Условия Dark Mode обновились. Ознакомься, чтобы продолжить.',
      dc_title: 'Dark Mode',
      dc_lead: 'Мы используем твои ответы о предпочтениях, чтобы считать интимную совместимость.',
      dc_b1: 'Видно только тем, у кого тоже включён Dark Mode',
      dc_b2: 'В ленте — только общие с тобой маркеры',
      dc_b3: 'После взаимного метча вы видите полные списки друг друга, одинаково',
      dc_b4: 'Это невозможно купить за ⭐ и не показывается никому другому',
      dc_affirm: 'Нажимая «Включить», ты подтверждаешь, что тебе исполнилось 18 лет, и даёшь согласие на обработку этих данных.',
      dc_enable: 'Включить', dc_cancel: 'Отмена',
      dc_policy: 'Выключить можно в любой момент — данные сразу перестают использоваться.',
      dc_more: 'Политика конфиденциальности',
      referral_terms: 'Награда начисляется, когда друг заполнит профиль минимум на 60% и вернётся в Sixtio на третий день. Количество друзей не ограничено.',
      ...
      kink_q_4: 'Что больше заводит — медленная чувственность или жгучая интенсивность?',
      kink_q_5: 'Что интересно попробовать: чувственные прикосновения, игрушки, массаж, соблазнительные слова?',
      ...
      ob_interests_q: 'Отметь, что тебе близко — выбери из списка. Своё сможешь добавить позже в профиле.',
      ob_interests_done: 'Готово',
      ...
      ob_photo_rejected: 'Это фото не соответствует правилам сообщества. Пожалуйста, выбери другое — без откровенного или оскорбительного содержания.',
      ob_photo_unavailable: 'Не удалось проверить фото — сервис проверки временно недоступен. Попробуй, пожалуйста, ещё раз.',
      ob_photo_retry: '🔄 Попробовать ещё раз',
      ...
      kink_tender: 'Нежность', kink_playful: 'Игривость', kink_slow: 'Без спешки', kink_intense: 'Интенсивность',
      kink_curious: 'Любопытство', kink_experimental: 'Эксперименты', kink_adventurous: 'Авантюрность', kink_vanilla: 'Классика',
      kink_kissing: 'Поцелуи', kink_cuddling: 'Объятия', kink_massage: 'Массаж', kink_sensation_play: 'Чувственные прикосновения',
      kink_teasing: 'Поддразнивание', kink_dirty_talk: 'Грязные разговоры', kink_sexting: 'Секстинг', kink_fantasies: 'Фантазии',
      kink_roleplay: 'Ролевые игры', kink_toys: 'Игрушки', kink_bondage: 'Бондаж', kink_blindfold: 'Вслепую',
      ...
      pw_report_name: 'AI-отчёт о тебе',
      pw_report_note: 'Знак и соционический тип — бесплатно. Платный — полный письменный разбор, навсегда.',
