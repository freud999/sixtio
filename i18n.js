...
(function () {
  var D = {
    ...
    uk: {
      ...
      report_disclaimer: 'Основа звіту — твої відповіді за моделлю Big Five. Знак зодіаку й соціотип — це мова опису та розвага, а не діагноз і не медична порада.',
    ...
    en: {
      ...
      report_disclaimer: 'The report is grounded in your own Big Five answers. The zodiac sign and socionics type are a language for describing you and a bit of fun — not a diagnosis and not medical advice.',
    ...
    ru: {
      ...
      report_disclaimer: 'Основа отчёта — твои ответы по модели Big Five. Знак зодиака и соционический тип — это язык описания и развлечение, а не диагноз и не медицинский совет.',
