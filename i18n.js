...
(function () {
  var D = {
    ...
    uk: {
      ...
      referral_terms: 'Реферал зараховується, коли друг завершить реєстрацію та почне користуватись Sixtio. Діють ліміти: до 10 нагород на добу.',
    ...
    en: {
      ...
      referral_terms: 'A referral counts once your friend finishes signing up and starts using Sixtio. Limits apply: up to 10 rewards per day.',
    ...
    ru: {
      ...
      referral_terms: 'Реферал засчитывается, когда друг завершит регистрацию и начнёт пользоваться Sixtio. Действуют лимиты: до 10 наград в сутки.',
